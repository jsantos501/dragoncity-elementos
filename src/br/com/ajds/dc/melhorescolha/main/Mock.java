...
public class Mock {
	...
	public static void main(String[] args) {
		...
		dragonsRivals.add(new Dragon("rival_1", Raridade.HEROICO,Elemento.MAR	,Elemento.GUERRA	,Elemento.TERRA	,Elemento.METAL));
		dragonsRivals.add(new Dragon("rival_2",Raridade.HEROICO,Elemento.MAR	,Elemento.GUERRA	,Elemento.TERRA	,Elemento.METAL));
		dragonsRivals.add(new Dragon("rival_3", Raridade.HEROICO,Elemento.MAR	,Elemento.GUERRA	,Elemento.TERRA	,Elemento.METAL));
